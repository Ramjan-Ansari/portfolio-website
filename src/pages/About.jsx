    ...
    <div className='py-24 px-2 md:px-4 relative'>
      <div className='container mx-auto max-w-5xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center '>
          ...
          <div className='space-x-6 opacity-0 animate-slide-right'>
            <h3 className='text-2xl font-semibold '>Passinate Web Devloper</h3>

            <p className='text-muted-foreground mt-4 text-justify'>Strong expertise in frontend–backend integration, with hands-on experience debugging and optimizing UI, APIs, authentication flows, and database operations.</p>

            <p className='text-muted-foreground mt-4 text-justify'>Experienced in designing scalable application architecture with clean code principles and performance optimization.</p>
            <p className='text-muted-foreground mt-4 text-justify'>Strong problem-solving mindset with the ability to analyze requirements and deliver efficient, production-ready solutions.</p>
      ...
      <div className="mt-12 px-2 sm:mt-20 text-center opacity-0 animate-fade-in-delay-3">
